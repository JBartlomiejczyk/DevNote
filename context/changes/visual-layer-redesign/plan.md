...
- [x] 2.1 Build przechodzi: `dotnet build` — 1c9daf4
- [x] 2.2 Wszystkie testy przechodzą: `dotnet test DevNote.Tests/DevNote.Tests.csproj` — 1c9daf4
...
- [x] 3.1 Build przechodzi: `dotnet build` — 0fe9cc5
- [x] 3.2 Wszystkie testy przechodzą: `dotnet test DevNote.Tests/DevNote.Tests.csproj` — 0fe9cc5
- [x] 3.3 Format nie wymaga zmian: `dotnet format --verify-no-changes --no-restore` — 0fe9cc5
...
- [x] 4.1 Build przechodzi: `dotnet build` — 710ff6a
- [x] 4.2 Wszystkie testy przechodzą: `dotnet test DevNote.Tests/DevNote.Tests.csproj` — 710ff6a
