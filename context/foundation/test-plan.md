...
| 2 | Auth & ownership boundary | Prove anonymous requests cannot reach user data and no user can read another user's note | #3, #4 | integration | planned | testing-auth-ownership-boundary |
