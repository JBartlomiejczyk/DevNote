...
|---|------------|-----------------|---------------|------------|--------|---------------|
| 1 | Test harness + classification/summary integrity | Bootstrap the xUnit runner and prove the LLM classify/summary parse cannot silently produce wrong or empty results | #1 | unit | change opened | testing-classification-summary-integrity |
| 2 | Auth & ownership boundary | Prove anonymous requests cannot reach user data and no user can read another user's note | #3, #4 | integration | not started | — |
